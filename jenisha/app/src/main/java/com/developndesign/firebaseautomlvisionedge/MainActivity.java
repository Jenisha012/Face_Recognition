...
public class MainActivity extends AppCompatActivity {
    ...
    Button button1; // To select the image from device
    Button button2;
    Button btn_logout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1 = findViewById(R.id.selectImage);
        button2 = findViewById(R.id.selectInfo);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotostdInfo = new Intent(MainActivity.this, StudentInfo.class);
                startActivity(gotostdInfo);
            }
        });
